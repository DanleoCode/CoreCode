package leavemanagement.valueobject;
...
public class EmployeeProfile extends EmployeeInfo{
	...
	private byte employeeAccountStatus;
	...
	public EmployeeProfile(String loginId, String password,
			...
			byte employeeAccountStatus, byte employeeType, int approver1,
	...
	public byte getEmployeeAccountStatus() {
		return employeeAccountStatus;
	}

	public void setEmployeeAccountStatus(byte employeeAccountStatus) {
		this.employeeAccountStatus = employeeAccountStatus;
	}
